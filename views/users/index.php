<div class="container-fluid bg-primary w-100 px-0 py-0 mx-0 my-0" style="min-height: 80vh">
    <div class="row w-100 px-0 py-0 mx-0 my-0">
        ...
        <div class="col-sm-12 col-md-9 col-lg-9 bg-info mx-0 my-0 px-0 py-0" style="min-height: 80vh">
            <div class="row h-100 w-100 bg-warning px-0 py-0 mx-0 my-0">
                        ...
                        <div class="row w-100 px-0 py-0 mx-0 my-0">
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-6">
                                <div class="container-fluid form-floating px-0 my-2 w-100">
                                    <select class="form-select" aria-label="Default select example" id="typeExpenses" name="typeExpensesId">
                                        <?php
                            ...
                            <div class="col-12 container-fluid form-floating px-0 my-2 w-100 d-flex justify-content-center">
                                <button type="submit" name="submit" value="submit" class="py-3 fs-6 w-50 badge rounded-pill bg-success">สร้างรายจ่าย</button>
                            </div>
                        </div>
                    </form>
                </div>
                <div class="col-12 d-flex flex-column justify-content-center align-items-center w-100 mx-0 my-0 px-3 py-0 w-100">
